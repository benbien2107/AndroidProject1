...
class ChatCustomAdapter(  private val dataSet: List<User>) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnClickListener {
        ...
        init {
            ...
            messageView = view.findViewById(R.id.message_chat)
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.messageView.text = dataSet[position].email;
